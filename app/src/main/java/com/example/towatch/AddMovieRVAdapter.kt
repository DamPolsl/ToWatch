...
class AddMovieRVAdapter(
    private val onMovieClicked: (AddMovieRVAdapter.MovieViewHolder, Int) -> Unit
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): AddMovieRVAdapter.MovieViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.movie_rv_list_item, parent, false)
        return MovieViewHolder(itemView)
    }

    override fun onBindViewHolder(holder: AddMovieRVAdapter.MovieViewHolder, position: Int) {
